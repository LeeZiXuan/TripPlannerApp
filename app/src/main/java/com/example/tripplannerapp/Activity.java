...
public class Activity {
    String act_name, act_type, act_address, act_des, act_startDateTime, act_endDateTime;

    public Activity() {
    }

    public Activity(String act_name, String act_type, String act_address, String act_des, String act_startDateTime, String act_endDateTime) {
